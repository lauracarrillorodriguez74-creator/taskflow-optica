...
const TF_CATS = ["Clinica", "Ventas", "Audiologia", "Taller", "Incidencias", "Seguimiento", "Inventario", "Limpieza", "Administracion", "LlamarCliente", "Reclamar"];

// Categorías que un trabajador no-gerente puede crear por sí mismo
const TF_WORKER_CATS = ["LlamarCliente", "Reclamar"];
...
const TF_LABELS = {
  ...
  LlamarCliente: "Llamar a cliente",
  Reclamar: "Reclamar"
}
...
Object.assign(window, {
  TF_STORES, TF_CATS, TF_WORKER_CATS, TF_PRIOS, TF_STATUSES, TF_LABELS,
